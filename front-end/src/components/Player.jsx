...
const Player = ({duration, randomIdFromArtist, randomId2FromArtist, audio}) => {
  ...
  useEffect(() => {
    // Reset currentTime and progressBar when audio changes
    resetPlayer();
  }, [audio]);
  ...
  return (
    <div className="player">
        ...
        <Link to={`/song/${randomIdFromArtist}`} onClick={resetPlayer}>
        ...
        <Link to={`/song/${randomId2FromArtist}`} onClick={resetPlayer}>
